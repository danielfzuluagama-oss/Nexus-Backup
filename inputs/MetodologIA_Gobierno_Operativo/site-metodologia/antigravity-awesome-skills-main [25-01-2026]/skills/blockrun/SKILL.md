...
|----------|----------|---------|
| Image generation | el modelo generativo | $0.04/image |
...
|-----------|-------------|
| "blockrun generate an image of a sunset" | Call el modelo generativo via ImageClient |
...
| "generate a logo for my startup" | Suggest el modelo generativo (you can't generate images) |
...
| el modelo generativo image | $0.04/image |

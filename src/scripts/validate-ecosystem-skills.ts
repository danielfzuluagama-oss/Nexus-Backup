...
function collectIssuesForWorkflow(
  workflow: unknown,
  workflowPath: string,
  issues: string[],
...
function validateSkillFile(filePath: string): ValidationFailure | null {
...
function walkSkillFiles(agentsPath: string): string[] {

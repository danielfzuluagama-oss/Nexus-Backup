...
import { decodeTaskPayloadFromBase64, ensureWebhookRegistration, getServiceContext, processTaskPayload, resolveWebhookBaseUrl, } from "./service.js";
const REGION = "us-central1";
const TOPIC = process.env.PUBSUB_TOPIC || "pristino-messages";
function resolveFunctionBaseUrl(request) {

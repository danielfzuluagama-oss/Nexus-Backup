...
function inferAudienceRole(normalizedMessage) {
    if (normalizedMessage.includes("cliente"))
        return "cliente";
    if (normalizedMessage.includes("implementador"))
        return "implementador";
    if (normalizedMessage.includes("pm"))
        return "pm";
    if (normalizedMessage.includes("ae"))
        return "ae";
    if (normalizedMessage.includes("lider"))
        return "lider";
...
async function tryOperationalFastPath(text, log) {

import { summarizeControlledTemplate, } from "./controlled-deliverables.js";
function buildTemplateHint(templateName) {
    if (!templateName)
        return "";
...
export function buildAgentResponseContract(intent) {

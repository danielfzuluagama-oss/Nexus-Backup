...
export function inferDeliverableLabel(normalizedMessage, templateName) {
    if (normalizedMessage.includes("html"))
        return "html entregable";
    if (templateName === "proposal")
        return "propuesta comercial";
    if (templateName === "brief")
        return "brief estrategico";
    if (templateName === "assessment")
        return "assessment operativo";
    if (normalizedMessage.includes("plan"))
        return "plan de accion";
    return "entregable operativo solicitado";
}
export function classifyTelegramIntent(text, options = {}) {

...
1. **Fases, no big-bang.** Cada fase es independientemente valiosa. Si el proyecto se detiene en Phase 2, lo construido en Phase 1 tiene valor por sí solo. [EXPLICIT]
2. **Estimaciones honestas.** Ranges con P50/P80/P95 — nunca un número exacto. El Cone of Uncertainty se respeta. [EXPLICIT]
...
- `{MODO}`: `piloto-auto` (default) | `desatendido` | `supervisado` | `paso-a-paso`
  ...
  - **desatendido**: Cero interrupciones. Roadmap completo auto-generado. Supuestos documentados. [EXPLICIT]

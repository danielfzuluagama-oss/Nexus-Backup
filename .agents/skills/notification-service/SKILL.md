...
description: FCM push notifications (topics, data messages). Email via SendGrid/Mailgun. In-app notifications via Firestore. [EXPLICIT]
version: 1.0.0
status: production
...
- "/notification-service" — Run the full notification service workflow
- "notification service on this project" — Apply to current context

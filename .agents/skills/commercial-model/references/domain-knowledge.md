# Domain Knowledge — commercial model

## Overview

This reference provides foundational knowledge for the commercial model skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that commercial model operates within | Direct input to skill execution [EXPLICIT] |

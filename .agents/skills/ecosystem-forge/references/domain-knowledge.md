# Domain Knowledge — ecosystem forge

## Overview

This reference provides foundational knowledge for the ecosystem forge skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that ecosystem forge operates within | Direct input to skill execution [EXPLICIT] |

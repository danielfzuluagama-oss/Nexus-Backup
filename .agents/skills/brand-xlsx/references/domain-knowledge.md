...
This reference provides foundational knowledge for the brand xlsx skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that brand xlsx operates within | Direct input to skill execution [EXPLICIT] |

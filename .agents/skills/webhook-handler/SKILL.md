...
description: Webhook receiver/sender patterns. Signature verification (Stripe, GitHub). Idempotency keys. Response formatting. [EXPLICIT]
version: 1.0.0
status: production
...
- "/webhook-handler" — Run the full webhook handler workflow
- "webhook handler on this project" — Apply to current context

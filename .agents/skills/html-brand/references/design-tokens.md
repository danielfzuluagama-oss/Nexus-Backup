# Sofka Design System v4 — Complete Token Reference
...
|---------|------|------|--------|-------------|-------|---|
| h1 | Clash Grotesk | clamp(2.5rem, 5vw, 4.2rem) | 700 | 1.1 | var(--sofka-white) on black | AA ✓ |
| h2 | Clash Grotesk | 2.2rem | 700 | 1.2 | var(--sofka-black) on light | AAA ✓ |
| h3 | Clash Grotesk | 1.8rem | 700 | 1.2 | var(--sofka-gray-900) on white | AAA ✓ |
| h4 | Clash Grotesk | 1.4rem | 600 | 1.3 | var(--sofka-gray-700) on white | AAA ✓ |
| Body | Inter | 1rem (16px) | 400 | 1.65 | var(--sofka-gray-700) on white | AAA ✓ |
| Small | Inter | 0.875rem | 400 | 1.5 | var(--sofka-gray-500) on white | AA ✓ |
| Badge | Inter | 0.7-0.75rem | 600 | — | Varies by type | AA+ ✓ |
| TOC link | Inter | 0.72rem | 600 | — | var(--sofka-gray-500) on white | AA ✓ |
...
```css
nav.toc { background: var(--sofka-white); position: sticky; top: 0; z-index: var(--z-sticky-nav); border-bottom: 1px solid var(--sofka-gray-200); box-shadow: var(--shadow-sm); }
...
### Cards
```css
.card { background: var(--sofka-white); border-radius: var(--radius-lg); padding: 2rem; box-shadow: var(--shadow-card); margin-bottom: 1.5rem; }
...
```css
.scenario-card { background: var(--sofka-white); border-radius: var(--radius-lg); padding: 2.5rem; margin-bottom: 1.5rem; box-shadow: var(--shadow-card); border-left: 6px solid; position: relative; overflow: visible; }
.scenario-card.a { border-left-color: var(--sofka-orange); }
.scenario-card.b { border-left-color: var(--sofka-info); }
.scenario-card.c { border-left-color: var(--sofka-critical); }
.scenario-card.b.recommended { box-shadow: 0 8px 32px rgba(37,99,235,.15); border: 2px solid var(--sofka-info); border-left: 6px solid var(--sofka-info); }
...
.scenario-label.a { background: rgba(255,126,8,.12); color: var(--sofka-orange); }
.scenario-label.b { background: rgba(37,99,235,.12); color: var(--sofka-info); }
.scenario-label.c { background: rgba(220,38,38,.12); color: var(--sofka-critical); }
.scenario-title { font-size: 1.6rem; font-family: var(--font-display); font-weight: 700; margin-bottom: .5rem; }
.scenario-subtitle { color: var(--sofka-gray-500); font-size: .95rem; margin-bottom: 1.5rem; }
.recommended-badge { position: absolute; top: -14px; left: 2rem; background: var(--sofka-info); color: white; padding: .35rem 1rem; border-radius: var(--radius-sm); font-size: .7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 4px 12px rgba(37,99,235,.3); }
```
...
.table-wrap td { padding: .875rem 1.25rem; border-bottom: 1px solid var(--sofka-gray-200); background: var(--sofka-white); }
.table-wrap tr:last-child td { border-bottom: none; }
.table-wrap tr:hover td { background: var(--sofka-gray-50); }
.table-wrap .check { color: var(--sofka-positive-text); font-weight: 700; }
.table-wrap .cross { color: var(--sofka-critical); font-weight: 600; }
.table-wrap .partial { color: var(--sofka-warning); font-weight: 600; }
```
...
.constraint-card { background: var(--sofka-white); border: 1px solid var(--sofka-gray-200); border-radius: var(--radius-md); padding: 1.5rem; transition: all var(--transition-normal); }
.constraint-card:hover { border-color: var(--sofka-orange); box-shadow: var(--shadow-md); }
.constraint-id { font-family: var(--font-display); font-size: .7rem; font-weight: 700; color: var(--sofka-orange); text-transform: uppercase; letter-spacing: 1px; margin-bottom: .5rem; }
.constraint-title { font-size: 1rem; font-weight: 600; color: var(--sofka-gray-900); margin-bottom: .75rem; }
.constraint-desc { font-size: .85rem; color: var(--sofka-gray-500); line-height: 1.6; }
```
...
.adr-card { background: var(--sofka-white); border: 1px solid var(--sofka-gray-200); border-radius: var(--radius-md); padding: 1.5rem; transition: all var(--transition-normal); }
.adr-card:hover { border-color: var(--sofka-orange); box-shadow: 0 8px 24px rgba(255,126,8,.12); transform: translateY(-2px); }
.adr-id { font-family: var(--font-display); font-size: .7rem; font-weight: 700; color: var(--sofka-orange); text-transform: uppercase; letter-spacing: 1px; margin-bottom: .5rem; }
.adr-card h4 { margin: 0 0 .75rem 0; font-size: 1.1rem; }
.adr-summary { font-size: .85rem; color: var(--sofka-gray-500); line-height: 1.6; margin-bottom: 1rem; }
.adr-btn { background: transparent; border: 1.5px solid var(--sofka-orange); color: var(--sofka-orange); padding: .4rem .9rem; border-radius: var(--radius-sm); cursor: pointer; font-size: .75rem; font-weight: 600; transition: all var(--transition-normal); }
.adr-btn:hover { background: var(--sofka-orange); color: var(--sofka-white); }
```

### Risk Cards
```css
.risk-card { background: var(--sofka-white); border-radius: var(--radius-md); padding: 1.5rem; margin-bottom: 1rem; border-left: 4px solid var(--sofka-critical); box-shadow: var(--shadow-sm); }
.risk-card.warning { border-left-color: var(--sofka-warning); }
.risk-card h4 { color: var(--sofka-critical); margin: 0 0 .75rem 0; font-size: 1rem; }
.risk-card.warning h4 { color: var(--sofka-warning); }
.risk-card p { font-size: .9rem; margin-bottom: .5rem; }
.risk-card .mitigation { background: var(--sofka-gray-50); padding: 1rem; border-radius: var(--radius-sm); margin-top: .75rem; font-size: .85rem; }
```
...
.pros { background: rgba(255,215,0,.08); border-left: 4px solid var(--sofka-positive); }
.cons { background: var(--sofka-critical-dim); border-left: 4px solid var(--sofka-critical); }
.pros h5, .cons h5 { margin-top: 0; margin-bottom: 1rem; font-size: .85rem; text-transform: uppercase; letter-spacing: 1px; }
.pros h5 { color: var(--sofka-positive-text); }
.cons h5 { color: var(--sofka-critical); }
.pros-cons ul { list-style: none; padding: 0; margin: 0; }
.pros-cons li { padding: .5rem 0 .5rem 1.5rem; position: relative; font-size: .9rem; }
.pros li::before { content: "✓"; position: absolute; left: 0; color: var(--sofka-positive-text); font-weight: 700; }
.cons li::before { content: "✕"; position: absolute; left: 0; color: var(--sofka-critical); font-weight: 700; }
```
...
.score-label { min-width: 140px; font-size: .8rem; font-weight: 600; color: var(--sofka-gray-700); }
.score-track { flex: 1; height: 28px; background: var(--sofka-gray-200); border-radius: var(--radius-sm); overflow: hidden; }
.score-fill { height: 100%; border-radius: var(--radius-sm); transition: width var(--transition-slow) ease; }
.score-fill.orange { background: linear-gradient(90deg, var(--sofka-orange), var(--sofka-orange-light)); }
.score-fill.blue { background: linear-gradient(90deg, var(--sofka-info), #60A5FA); }
.score-fill.red { background: linear-gradient(90deg, var(--sofka-critical), #F87171); }
.score-value { min-width: 40px; font-size: .78rem; font-weight: 700; text-align: right; }
.score-value.orange { color: var(--sofka-orange); }
.score-value.blue { color: var(--sofka-info); }
.score-value.red { color: var(--sofka-critical); }
```

### Gains/Risks Cards
```css
.gain-risk-card { background: var(--sofka-white); border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-card); border: 1px solid var(--sofka-gray-200); }
.gain-risk-card.recommended { border: 2px solid var(--sofka-info); box-shadow: 0 8px 24px rgba(37,99,235,.15); }
.gain-risk-header { padding: 1rem 1.25rem; font-weight: 700; font-size: .8rem; text-transform: uppercase; letter-spacing: 1px; border-bottom: 1px solid var(--sofka-gray-200); }
.gain-risk-header.a { background: rgba(255,126,8,.06); color: var(--sofka-orange); }
.gain-risk-header.b { background: rgba(37,99,235,.08); color: var(--sofka-info); border-bottom-color: var(--sofka-info); }
.gain-risk-header.c { background: rgba(220,38,38,.06); color: var(--sofka-critical); }
.gain-risk-body { padding: 1.25rem; }
.gain-risk-list { list-style: none; padding: 0; margin: 0; }
.gain-risk-list li { padding: .35rem 0 .35rem 1.5rem; position: relative; font-size: .85rem; color: var(--sofka-gray-700); }
.gain-risk-list li.gain::before { content: "✓"; position: absolute; left: 0; color: var(--sofka-positive-text); font-weight: 700; }
.gain-risk-list li.risk::before { content: "✕"; position: absolute; left: 0; color: var(--sofka-critical); font-weight: 700; }
.gain-risk-divider { border-top: 1px solid var(--sofka-gray-200); margin: 1rem 0; }
```

### Roadmap Links
```css
.roadmap-link { border-radius: var(--radius-md); padding: 1.5rem; margin: 1rem 0; border-left: 4px solid; }
.roadmap-link.a { background: var(--sofka-orange-dim); border-color: var(--sofka-orange); }
.roadmap-link.b { background: var(--sofka-info-dim); border-color: var(--sofka-info); }
.roadmap-link.c { background: var(--sofka-critical-dim); border-color: var(--sofka-critical); }
...
.decision-list li { padding: 1.25rem 0 1.25rem 2rem; position: relative; font-size: .95rem; border-bottom: 1px solid var(--sofka-gray-200); }
.decision-list li:last-child { border-bottom: none; }
.decision-list li::before { content: "→"; position: absolute; left: 0; color: var(--sofka-info); font-weight: 700; font-size: 1.1rem; }
```

### Timeline Steps
```css
.steps { counter-reset: step; list-style: none; padding: 0; margin: 1.5rem 0; }
.steps li { counter-increment: step; padding: 1.25rem 0 1.25rem 3.5rem; position: relative; border-bottom: 1px solid var(--sofka-gray-200); }
.steps li:last-child { border-bottom: none; }
.steps li::before { content: counter(step); position: absolute; left: 0; top: 1.25rem; width: 2.2rem; height: 2.2rem; background: var(--sofka-black); color: var(--sofka-orange); font-family: var(--font-display); font-weight: 700; font-size: .9rem; display: flex; align-items: center; justify-content: center; border-radius: var(--radius-sm); }
```
...
.modal-content { background: var(--sofka-white); border-radius: var(--radius-lg); max-width: 700px; width: 100%; max-height: 85vh; overflow-y: auto; padding: 2.5rem; position: relative; box-shadow: var(--shadow-lg); }
.modal-close { position: absolute; top: 1.25rem; right: 1.25rem; background: var(--sofka-gray-50); border: 1px solid var(--sofka-gray-200); width: 2rem; height: 2rem; border-radius: 50%; cursor: pointer; font-size: 1rem; display: flex; align-items: center; justify-content: center; color: var(--sofka-gray-500); transition: all var(--transition-normal); }
.modal-close:hover { background: var(--sofka-critical); color: var(--sofka-white); border-color: var(--sofka-critical); }
.modal-content h3 { margin: 0 0 1.5rem 0; font-size: 1.4rem; padding-right: 2rem; }
.modal-content h4 { margin: 1.5rem 0 .75rem 0; font-size: 1rem; color: var(--sofka-gray-900); }
...
.modal-content li::before { content: "▸"; position: absolute; left: 0; color: var(--sofka-orange); font-weight: 700; }
```
...
@media (prefers-color-scheme: dark) {
  ...
  /* When implemented, create --sofka-*-dark variants for semantic colors */
}
```

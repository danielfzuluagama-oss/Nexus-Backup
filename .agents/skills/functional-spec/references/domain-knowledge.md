...
This reference provides foundational knowledge for the functional spec skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that functional spec operates within | Direct input to skill execution [EXPLICIT] |

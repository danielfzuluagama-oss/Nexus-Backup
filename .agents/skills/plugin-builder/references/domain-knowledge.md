# Domain Knowledge — plugin builder

## Overview

This reference provides foundational knowledge for the plugin builder skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that plugin builder operates within | Direct input to skill execution [EXPLICIT] |

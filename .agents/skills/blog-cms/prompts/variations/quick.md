...
type: variation
version: 2.0.0
description: "Blog Cms in quick mode."
---
...
Use quick mode when you need adjusted depth for the Blog Cms workflow.
...
1. Load skill: `skills/blog-cms/knowledge/body-of-knowledge.md`

...
version: 1.0.0
description: >
  User onboarding flows, activation metrics, time-to-value optimization. [EXPLICIT]
  Trigger: "onboarding ux, user onboarding flows, activation metrics, time-to-value optimization"
allowed-tools:
  - Read
  - Write
  - Glob
...
User onboarding flows, activation metrics, time-to-value optimization. All outputs follow MetodologIA brand standards and evidence tagging. [EXPLICIT]

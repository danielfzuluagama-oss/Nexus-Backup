...
type: execution
version: 2.0.0
description: "Execute the Design System workflow with triad orchestration."
triad:
  lead: "design-system-lead"
  support: "design-system-support"
  guardian: "design-system-guardian"
---

# Design System — Execute
...
3. **Lead** (`design-system-lead`): Execute SKILL.md Steps 1-4 for `{{task}}`
   - Discover → Analyze → Execute → Validate
   - Apply evidence tags on all claims
4. **Support** (`design-system-support`): Review for cross-cutting concerns
   - Edge cases, security, accessibility, performance
5. **Guardian** (`design-system-guardian`): Validate

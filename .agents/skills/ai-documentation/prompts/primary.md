...
type: execution
version: 2.0.0
description: "Execute the Ai Documentation workflow with triad orchestration."
triad:
...
3. **Lead** (`ai-documentation-lead`): Execute SKILL.md Steps 1-4 for `{{task}}`
   - Discover → Analyze → Execute → Validate
   - Apply evidence tags on all claims
4. **Support** (`ai-documentation-support`): Review for cross-cutting concerns
   - Edge cases, security, accessibility, performance
5. **Guardian** (`ai-documentation-guardian`): Validate

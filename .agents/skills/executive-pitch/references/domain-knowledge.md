# Domain Knowledge — executive pitch

## Overview

This reference provides foundational knowledge for the executive pitch skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that executive pitch operates within | Direct input to skill execution [EXPLICIT] |

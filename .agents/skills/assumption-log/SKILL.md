---
name: assumption-log
description: Track and validate assumptions. Format: A-NNN assumption, status (unvalidated/validated/invalidated), evidence tag. [EXPLICIT]
version: 1.0.0
status: production
...
- "/assumption-log" — Run the full assumption log workflow
- "assumption log on this project" — Apply to current context

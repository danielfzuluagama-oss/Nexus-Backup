...
description: 7-dimension feasibility within Firebase/Google/Hostinger. Score 1-5 per dimension. Evidence-tagged findings. [EXPLICIT]
version: 1.0.0
status: production
...
- "/technical-feasibility" — Run the full technical feasibility workflow
- "technical feasibility on this project" — Apply to current context

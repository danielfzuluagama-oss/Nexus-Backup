---
name: file-storage
description: Firebase Cloud Storage. Upload with progress. Security rules. Image processing triggers (resize, watermark, thumbnails). [EXPLICIT]
version: 1.0.0
status: production
...
- "/file-storage" — Run the full file storage workflow
- "file storage on this project" — Apply to current context

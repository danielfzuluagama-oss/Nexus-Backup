# Domain Knowledge — open claw builder

## Overview

This reference provides foundational knowledge for the open claw builder skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that open claw builder operates within | Direct input to skill execution [EXPLICIT] |

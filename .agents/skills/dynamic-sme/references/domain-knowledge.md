# Domain Knowledge — dynamic sme

## Overview

This reference provides foundational knowledge for the dynamic sme skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that dynamic sme operates within | Direct input to skill execution [EXPLICIT] |

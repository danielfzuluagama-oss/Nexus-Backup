...
description: React 19+ project with Firebase integration. Routing (React Router v7), Auth context, Firestore hooks, TypeScript. [EXPLICIT]
version: 1.0.0
status: production
...
- "/scaffold-react-app" — Run the full scaffold react app workflow
- "scaffold react app on this project" — Apply to current context

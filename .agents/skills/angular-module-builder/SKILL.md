...
description: Angular feature modules with standalone components. Services, pipes, directives, Angular Material integration. [EXPLICIT]
version: 1.0.0
status: production
...
- "/angular-module-builder" — Run the full angular module builder workflow
- "angular module builder on this project" — Apply to current context

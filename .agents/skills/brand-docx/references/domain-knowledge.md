...
This reference provides foundational knowledge for the brand docx skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that brand docx operates within | Direct input to skill execution [EXPLICIT] |

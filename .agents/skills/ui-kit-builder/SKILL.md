---
name: ui-kit-builder
description: Design-token-driven UI kit. Button, Card, Modal, Table, Nav, Badge, Toast components. Theme switching support. [EXPLICIT]
version: 1.0.0
status: production
...
- "/ui-kit-builder" — Run the full ui kit builder workflow
- "ui kit builder on this project" — Apply to current context

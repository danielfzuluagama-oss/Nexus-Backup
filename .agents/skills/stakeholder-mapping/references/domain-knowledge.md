...
This reference provides foundational knowledge for the stakeholder mapping skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that stakeholder mapping operates within | Direct input to skill execution [EXPLICIT] |

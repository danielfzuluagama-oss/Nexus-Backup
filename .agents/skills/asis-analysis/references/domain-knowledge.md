# Domain Knowledge — asis analysis

## Overview

This reference provides foundational knowledge for the asis analysis skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that asis analysis operates within | Direct input to skill execution [EXPLICIT] |

# Domain Knowledge — rule forge

## Overview

This reference provides foundational knowledge for the rule forge skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that rule forge operates within | Direct input to skill execution [EXPLICIT] |

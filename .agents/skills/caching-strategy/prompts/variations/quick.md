...
type: variation
version: 2.0.0
description: "Caching Strategy in quick mode."
---
...
Use quick mode when you need adjusted depth for the Caching Strategy workflow.
...
1. Load skill: `skills/caching-strategy/knowledge/body-of-knowledge.md`

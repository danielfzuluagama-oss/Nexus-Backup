# Domain Knowledge — mcp creator

## Overview

This reference provides foundational knowledge for the mcp creator skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that mcp creator operates within | Direct input to skill execution [EXPLICIT] |

# Domain Knowledge — skill spec creator

## Overview

This reference provides foundational knowledge for the skill spec creator skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that skill spec creator operates within | Direct input to skill execution [EXPLICIT] |

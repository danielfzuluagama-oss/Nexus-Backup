...
description: Semantic HTML5 page construction. Landmarks, ARIA roles, structured data (JSON-LD), Open Graph meta, accessibility. [EXPLICIT]
version: 1.0.0
status: production
...
- "/html-semantic-builder" — Run the full html semantic builder workflow
- "html semantic builder on this project" — Apply to current context

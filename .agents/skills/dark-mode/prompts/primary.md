...
type: execution
version: 2.0.0
description: "Execute the Dark Mode workflow with triad orchestration."
triad:
  lead: "dark-mode-lead"
  support: "dark-mode-support"
  guardian: "dark-mode-guardian"
---
...
3. **Lead** (`dark-mode-lead`): Execute SKILL.md Steps 1-4 for `{{task}}`
   - Discover → Analyze → Execute → Validate
   - Apply evidence tags on all claims
4. **Support** (`dark-mode-support`): Review for cross-cutting concerns
   - Edge cases, security, accessibility, performance
5. **Guardian** (`dark-mode-guardian`): Validate

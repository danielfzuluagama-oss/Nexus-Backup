...
type: variation
version: 2.0.0
description: "User Prompt Filter in quick mode."
---
...
Use quick mode when you need adjusted depth for the User Prompt Filter workflow.
...
1. Load skill: `skills/user-prompt-filter/knowledge/body-of-knowledge.md`

...
description: Modern JS patterns. ES modules, async/await, Web APIs (Intersection/Resize/Mutation Observer), event delegation, AbortController. [EXPLICIT]
version: 1.0.0
status: production
...
- "/javascript-patterns" — Run the full javascript patterns workflow
- "javascript patterns on this project" — Apply to current context

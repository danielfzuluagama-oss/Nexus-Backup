# Domain Knowledge — workshop facilitator

## Overview

This reference provides foundational knowledge for the workshop facilitator skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that workshop facilitator operates within | Direct input to skill execution [EXPLICIT] |

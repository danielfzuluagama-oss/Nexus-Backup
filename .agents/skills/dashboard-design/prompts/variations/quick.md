---
name: dashboard-design-quick
type: variation
version: 2.0.0
description: "Dashboard Design in quick mode."
---
...
Use quick mode when you need adjusted depth for the Dashboard Design workflow.
...
1. Load skill: `skills/dashboard-design/knowledge/body-of-knowledge.md`

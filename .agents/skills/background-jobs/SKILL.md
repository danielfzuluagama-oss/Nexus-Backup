...
description: Cloud Tasks for deferred work. Pub/Sub event-driven. Scheduled functions (cron). Retry policies. Dead letter queues. [EXPLICIT]
version: 1.0.0
status: production
...
- "/background-jobs" — Run the full background jobs workflow
- "background jobs on this project" — Apply to current context

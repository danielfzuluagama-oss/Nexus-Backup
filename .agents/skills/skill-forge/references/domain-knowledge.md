# Domain Knowledge — skill forge

## Overview

This reference provides foundational knowledge for the skill forge skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that skill forge operates within | Direct input to skill execution [EXPLICIT] |

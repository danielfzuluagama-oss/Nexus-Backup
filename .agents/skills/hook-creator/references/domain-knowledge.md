# Domain Knowledge — hook creator

## Overview

This reference provides foundational knowledge for the hook creator skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that hook creator operates within | Direct input to skill execution [EXPLICIT] |

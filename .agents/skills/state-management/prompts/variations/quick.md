...
type: variation
version: 2.0.0
description: "State Management in quick mode."
---

# State Management — quick Mode

## When to Use

Use quick mode when you need adjusted depth for the State Management workflow.
...
1. Load skill: `skills/state-management/knowledge/body-of-knowledge.md`

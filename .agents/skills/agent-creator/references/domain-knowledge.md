...
This reference provides foundational knowledge for the agent creator skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that agent creator operates within | Direct input to skill execution [EXPLICIT] |

# Domain Knowledge — flow mapping

## Overview

This reference provides foundational knowledge for the flow mapping skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that flow mapping operates within | Direct input to skill execution [EXPLICIT] |

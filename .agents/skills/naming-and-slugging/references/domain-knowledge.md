# Domain Knowledge — naming and slugging

## Overview

This reference provides foundational knowledge for the naming and slugging skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that naming and slugging operates within | Direct input to skill execution [EXPLICIT] |

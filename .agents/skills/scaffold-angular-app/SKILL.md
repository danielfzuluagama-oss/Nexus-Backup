...
description: Angular 18+ with AngularFire. Standalone components, signals, guards, services, interceptors, lazy routes. [EXPLICIT]
version: 1.0.0
status: production
...
- "/scaffold-angular-app" — Run the full scaffold angular app workflow
- "scaffold angular app on this project" — Apply to current context

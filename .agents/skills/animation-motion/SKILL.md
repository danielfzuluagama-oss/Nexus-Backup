...
description: CSS transitions and animations. @keyframes, scroll-driven animations, View Transitions API, Lottie integration. [EXPLICIT]
version: 1.0.0
status: production
...
- "/animation-motion" — Run the full animation motion workflow
- "animation motion on this project" — Apply to current context

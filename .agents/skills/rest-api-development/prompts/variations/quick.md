...
type: variation
version: 2.0.0
description: "Rest Api Development in quick mode."
---
...
Use quick mode when you need adjusted depth for the Rest Api Development workflow.
...
1. Load skill: `skills/rest-api-development/knowledge/body-of-knowledge.md`

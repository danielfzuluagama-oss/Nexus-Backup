# Domain Knowledge — brand voice

## Overview

This reference provides foundational knowledge for the brand voice skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that brand voice operates within | Direct input to skill execution [EXPLICIT] |

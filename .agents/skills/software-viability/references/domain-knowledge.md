# Domain Knowledge — software viability

## Overview

This reference provides foundational knowledge for the software viability skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that software viability operates within | Direct input to skill execution [EXPLICIT] |

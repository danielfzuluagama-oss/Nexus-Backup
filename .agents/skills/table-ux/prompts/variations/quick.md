...
type: variation
version: 2.0.0
description: "Table Ux in quick mode."
---
...
Use quick mode when you need adjusted depth for the Table Ux workflow.
...
1. Load skill: `skills/table-ux/knowledge/body-of-knowledge.md`

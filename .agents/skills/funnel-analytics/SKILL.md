...
version: 1.0.0
description: >
  Conversion funnel tracking, drop-off analysis, optimization strategy. [EXPLICIT]
  Trigger: "funnel analytics"
allowed-tools:
  - Read
  - Write
  - Glob
...
- "funnel analytics on this project" — Apply to current context

...
description: Product vision and roadmap. Feature prioritization (MoSCoW/RICE). Value stream mapping. Google ecosystem positioning. [EXPLICIT]
version: 1.0.0
status: production
...
- "/product-strategy" — Run the full product strategy workflow
- "product strategy on this project" — Apply to current context

...
version: 1.0.0
description: >
  Alt text guidelines, plain language, reading level, inclusive language. [EXPLICIT]
  Trigger: "accessibility writing"
allowed-tools:
  - Read
  - Write
  - Glob
...
- "accessibility writing on this project" — Apply to current context

# Domain Knowledge — cost estimation

## Overview

This reference provides foundational knowledge for the cost estimation skill. [EXPLICIT]

## Key Concepts

| Concept | Definition | Relevance |
|---------|-----------|-----------|
| Primary domain | The core domain that cost estimation operates within | Direct input to skill execution [EXPLICIT] |

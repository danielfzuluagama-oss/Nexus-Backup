...
type: variation
version: 2.0.0
description: "Pre Compact Context in quick mode."
---
...
Use quick mode when you need adjusted depth for the Pre Compact Context workflow.
...
1. Load skill: `skills/pre-compact-context/knowledge/body-of-knowledge.md`

...
description: Algolia/Typesense/Meilisearch integration. Firestore to search index sync via Cloud Functions. Faceted search. Autocomplete. [EXPLICIT]
version: 1.0.0
status: production
...
- "/search-implementation" — Run the full search implementation workflow
- "search implementation on this project" — Apply to current context

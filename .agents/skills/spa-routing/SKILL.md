---
name: spa-routing
description: Client-side routing for React Router v7 or Angular Router. Firebase Hosting rewrites for SPA. Route guards, lazy loading. [EXPLICIT]
version: 1.0.0
status: production
...
- "/spa-routing" — Run the full spa routing workflow
- "spa routing on this project" — Apply to current context
